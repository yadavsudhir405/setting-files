# Uncomment below to see the time taken to load zshrc
#zmodload zsh/zprof
# Power level10 k plugin
# If you come from bash you might have to change your $PATH.
export PATH=$HOME/bin:/usr/local/bin:/Users/sudhir/.pyenv/bin:$PATH
export PATH="$HOME/Library/Python/3.9/bin:/usr/bin:$HOME/.jenv/bin:$PATH:$HOME/.npm-packages/bin:/usr/local/bin:$PATH"
...
# Add wisely, as too many plugins slow down shell startup.
 # plugins=(evalcache git colored-man-pages colorize pip python brew zsh-autosuggestions autojump docker zsh-interactive-cd)
